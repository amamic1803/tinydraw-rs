...
pub struct ImageRGB {
    width: usize, // width of an image
    height: usize, // height of an image
    background: [u8; 3], // background color of the image (used only with ImageRGB::new())
    image_data: Vec<[u8; 3]>, // vector pixels of the image
...
impl ImageRGB {
    ...
    fn draw_line(&mut self, x1: usize, y1: usize, x2: usize, y2: usize, color: [u8; 3]) {
    ...
    fn draw_rectangle(&mut self, x1: usize, y1: usize, x2: usize, y2: usize, color: [u8; 3], thickness: usize) {
    ...
    fn draw_rectangle_filled(&mut self, x1: usize, y1: usize, x2: usize, y2: usize, color: [u8; 3],) {
